...
file1 = 'models/cat0.off'
file2 = 'models/cat1.off'
...
mesh2 = openmesh.read_trimesh(file2)
ps.init()
ps_mesh = ps.register_surface_mesh("mesh", mesh.points(), mesh.face_vertex_indices())
ps_mesh = ps.register_surface_mesh("mesh2", mesh2.points(), mesh2.face_vertex_indices())
